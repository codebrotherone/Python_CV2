...
#     """
#     print 'STARTING TO FIND STOP SIGN ....'
#     imgc=img_in.copy()
#     img = cv2.cvtColor(imgc, cv2.COLOR_BGR2GRAY)
#
#     #perform canny operation
#     canny_edges = cv2.Canny(img, threshold1=120, threshold2=50, apertureSize=5)
#     #define parameters
#     minLineLength = 20
#     maxGap = 5
#     theta = 45
#
#     lines = cv2.HoughLinesP(image=canny_edges, rho=1, theta=np.pi/180*theta, threshold=20, minLineLength=minLineLength, maxLineGap=maxGap)
#
#     combos = list(itertools.combinations(lines[0, :], 2))
#     combos.sort(key=lambda x: cmp_slope_lines(x[0], x[1]))
#     combos = sorted(combos, key=lambda x: cmp_dist_lines(x[0], x[1]))
#
#
#     print 'CHECKING OUR SORT'
#     for pair in combos:
#         print pair
#         print '\n'
#         print cmp_slope_lines(pair[0], pair[1])
#         print '\n'
#         print cmp_dist_lines(pair[0], pair[1])
#
#     centroid = ()
#
#     for pair in combos:
#         # if cmp_dist_lines(pair[0], pair[1], threshold=5):
#         centroid = find_center_parallel_lines(pair[0], pair[1])
#         print 'centroid is {}'.format(centroid)
#         b, g, r = imgc[centroid[1], centroid[0]]
#         print 'B, G, R'
#         print b, g, r
#
#         if(b==0 and r>=200 and g==0) or (b==255 and g==255 and r==255):
#             print 'this is our center {}'
#             print centroid
#             return centroid
#         else:
