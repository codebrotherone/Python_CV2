...
def part_5():
    ...
    """
    template_rect_1 = {'x': 71, 'y': 170, 'w': 70, 'h': 150}
    template_rect_2 = {'x': 290, 'y': 200, 'w': 60, 'h': 120}
    template_rect_3 = {'x': 30, 'y': 210, 'w': 60, 'h': 120}
    ...
    for img in imgs_list:
        ...
        if templates != []:
            ...
            pf1 = ps5.AppearanceModelPF(frame, template=template1, template_coords=template_rect_1, **kwargs1)
            pf2 = ps5.AppearanceModelPF(frame, template=template2, template_coords=template_rect_2,  **kwargs2)
        ...
        if frame_num == 36:
            template3 = frame[int(template_rect_3['y']):
                              int(template_rect_3['y'] + template_rect_3['h']),
                              int(template_rect_3['x']):
                              int(template_rect_3['x'] + template_rect_3['w'])]
            if 'template3' in save_frames:
                cv2.imwrite(save_frames['template3'], template3)
            pf3 = ps5.AppearanceModelPF(frame, template=template3, template_coords=template_rect_3, **kwargs3)
        ...
        if frame_num in save_frames:
            ...
            print 'THIS FRAME NUM {}'.format(frame_num)
            cv2.imwrite(save_frames[frame_num], frame_out)
